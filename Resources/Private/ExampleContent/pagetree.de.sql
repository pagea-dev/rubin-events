--
-- Example page structure for EXT:rubin_events — German.
--
-- Same structure as pagetree.en.sql, only the page titles and content element headers differ. The
-- importer picks the file by the backend language of the user who clicks the button:
-- pagetree.<language code>.sql, falling back to pagetree.en.sql.
--
...
VALUES (###PARENT###, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 256, 1, 'Rubin Events – Beispielseiten', 1, 1, 0, 31, 31, 0);

-- @as list
INSERT INTO pages (pid, tstamp, crdate, sorting, doktype, title, nav_hide, perms_userid, perms_groupid, perms_user, perms_group, perms_everybody)
VALUES (###PAGE:root###, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 256, 1, 'Termine', 1, 1, 0, 31, 31, 0);

-- @as slider
INSERT INTO pages (pid, tstamp, crdate, sorting, doktype, title, nav_hide, perms_userid, perms_groupid, perms_user, perms_group, perms_everybody)
VALUES (###PAGE:root###, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 512, 1, 'Termine als Slider', 1, 1, 0, 31, 31, 0);

-- @as detail
INSERT INTO pages (pid, tstamp, crdate, sorting, doktype, title, nav_hide, perms_userid, perms_groupid, perms_user, perms_group, perms_everybody)
VALUES (###PAGE:root###, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 768, 1, 'Termin-Detail', 1, 1, 0, 31, 31, 0);

-- @as data
INSERT INTO pages (pid, tstamp, crdate, sorting, doktype, title, nav_hide, perms_userid, perms_groupid, perms_user, perms_group, perms_everybody)
VALUES (###PAGE:root###, UNIX_TIMESTAMP(), UNIX_TIMESTAMP(), 1024, 254, 'Event-Daten', 1, 1, 0, 31, 31, 0);
